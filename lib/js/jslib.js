...
function _domAddStyleClassToRef(nodeRef, className, kappa){
  nodeRef.classList.add(className);
  return _yieldCont(kappa, CONSTANTS.UNIT);
}

// domRemoveStyleClassFromRef: (DomNode, String) -> ()
function _domRemoveStyleClassFromRef(nodeRef, className, kappa){
...
const domAddStyleClassToRef = LINKS.kify(_domAddStyleClassToRef);
const domRemoveAttributeFromRef = LINKS.kify(_domRemoveAttributeFromRef);
